...
text_file = open("/Users/Helicopter/Desktop/election_twitters/Output_kasich.txt", "w")
for tweet in tweepy.Cursor(api.search, q='voteforkasich', since='2016-01-01', until='2016-04-01').items():
...
for tweet in tweepy.Cursor(api.search, q='vote4kasich', since='2016-01-01', until='2016-04-01').items():
	content = str_pre_process(tweet.text)
	for word in content.split():
		letters_only = re.sub("[^a-zA-Z]", "", word)
		word = letters_only.lower()
...
for tweet in tweepy.Cursor(api.search, q='kasich4us', since='2016-01-01', until='2016-04-01').items():
	content = str_pre_process(tweet.text)
	for word in content.split():
		letters_only = re.sub("[^a-zA-Z]", "", word)
		word = letters_only.lower()
		if word not in stops:
			print word,
			text_file.write("%s " %word)
for tweet in tweepy.Cursor(api.search, q='johnkasich4president', since='2016-01-01', until='2016-04-01').items():
	content = str_pre_process(tweet.text)
	for word in content.split():
		letters_only = re.sub("[^a-zA-Z]", "", word)
		word = letters_only.lower()
		if word not in stops:
			print word,
			text_file.write("%s " %word)
for tweet in tweepy.Cursor(api.search, q='kasichforus', since='2016-01-01', until='2016-04-01').items():
	content = str_pre_process(tweet.text)
	for word in content.split():
		letters_only = re.sub("[^a-zA-Z]", "", word)
		word = letters_only.lower()
...
text_file = open("/Users/Helicopter/Desktop/election_twitters/Output_sanders.txt", "w")
for tweet in tweepy.Cursor(api.search, q='voteforbernie', since='2016-01-01', until='2016-04-01').items():
	content = str_pre_process(tweet.text)
	for word in content.split():
		letters_only = re.sub("[^a-zA-Z]", "", word)
		word = letters_only.lower()
...
for tweet in tweepy.Cursor(api.search, q='voteforsanders', since='2016-01-01', until='2016-04-01').items():
	...
	for word in content.split():
		...
		if word not in stops:
			print word,
			text_file.write("%s " %word)
for tweet in tweepy.Cursor(api.search, q='votebernie', since='2016-01-01', until='2016-04-01').items():
	content = str_pre_process(tweet.text)
	for word in content.split():
		letters_only = re.sub("[^a-zA-Z]", "", word)
		word = letters_only.lower()
...
for tweet in tweepy.Cursor(api.search, q='votesanders', since='2016-01-01', until='2016-04-01').items():
	content = str_pre_process(tweet.text)
	for word in content.split():
		letters_only = re.sub("[^a-zA-Z]", "", word)
		word = letters_only.lower()
		if word not in stops:
			print word,
			text_file.write("%s " %word)
for tweet in tweepy.Cursor(api.search, q='berniesanders2016', since='2016-01-01', until='2016-04-01').items():
	content = str_pre_process(tweet.text)
	for word in content.split():
		letters_only = re.sub("[^a-zA-Z]", "", word)
		word = letters_only.lower()
...
for tweet in tweepy.Cursor(api.search, q='bernie2016', since='2016-01-01', until='2016-04-01').items():
	content = str_pre_process(tweet.text)
	for word in content.split():
		letters_only = re.sub("[^a-zA-Z]", "", word)
		word = letters_only.lower()
		if word not in stops:
			print word,
			text_file.write("%s " %word)
for tweet in tweepy.Cursor(api.search, q='birdiesanders', since='2016-01-01', until='2016-04-01').items():
	content = str_pre_process(tweet.text)
	for word in content.split():
		letters_only = re.sub("[^a-zA-Z]", "", word)
		word = letters_only.lower()
